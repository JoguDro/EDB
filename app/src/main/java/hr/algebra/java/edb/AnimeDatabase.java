...
public class AnimeDatabase {
    ...
    public static String DBNAME = "AnimeDB";
    public static String DBTABLE = "anime";
    ...
    public AnimeDatabase open() throws SQLException {
    ...
    public void insert(String text2, String text3, String text4, String text5) {
        if (!isExist(text2)) {
            sqlDb.execSQL("INSERT INTO anime (name,genre,rating,year) VALUES('" + text2 + "','" + text3 + "','" + text4 + "','" + text5 + "')");
        }
    }


    public boolean isExist(String n) {
        String query = "SELECT name FROM anime WHERE name='" + n + "' LIMIT 1";
