...
public class MoviesDatabase {
    ...
    public static String DBNAME = "MoviesDB";
    public static String DBTABLE = "movies";
    ...
    public void insert(String text2, String text3, String text4, String text5) {
        if (!isExist(text2)) {
            sqlDb.execSQL("INSERT INTO movies (name,genre,rating,year) VALUES('" + text2 + "','" + text3 + "','" + text4 + "','" + text5 + "')");
        }
    }


    public boolean isExist(String n) {
        String query = "SELECT name FROM movies WHERE name='" + n + "' LIMIT 1";
